...
//$query = "SELECT cFName,cLName,username,password,phoneNumber,email,COUNT(*) AS address FROM customer,address WHERE customer.cID = address.cID AND cID = $cID";
$query = "SELECT cFName,cLName,username,password,phoneNumber,email,COUNT(*) AS address FROM customer,address WHERE customer.cID = address.cID and customer.cID=$cID";
   ...
   <div class="container" >
       <div class="row profile">
        ...
        <div class="profile-content" id="content">
          <h1><?php echo $_SESSION["customerUsername"].'\'s profile'?></h1>
        <table class="table">
          <tbody>
            <tr>
              <th>First Name</td>
            ...
            <tr>
              <th>Address</td>
                ...
                if($address==0){
                  ...
                  $query = "SELECT addressID FROM address where cID = $cID";
                  $result = $mysqli->query($query);
                for($i=1;$i<=$address;$i++){
                      $row = $result ->fetch_array();
                      $addressID = $row['addressID'];
                      echo "<a href='address.php?viewaddress=$addressID'>View Address$i </a>";
                }} ?>
              </td>
            </tr>
          </tbody>
    ...
    <div class="row">
      <div class="col-md-9 col-md-offset-3">
        <div class="profile-content" id="content">
          <h1><?php echo $_SESSION["customerUsername"].'\'s Address '.$addressNum?></h1>
        <table class="table">
          <tbody>
            <tr>
              <th>Address</td>
